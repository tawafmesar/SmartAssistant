...
class AppColor {
  ...
  static const  Color scaffoldBackgroundColor = const Color(0xFFCEEAFD);
  static const  Color cardColor = const Color(0xFFD4D7F6);
  ...
  static Color clockOutline = Color(0xFFD4D7F6);
